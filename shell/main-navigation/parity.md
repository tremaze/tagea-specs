...
| 2026-09-23 | claude   | Dateien: both catalogue rows now state the `requireFileStorageAccess` rule (`files.view` / `institution.files.view`); `file_storage.access` no longer gates anything. Flutter follows the teamspace rule. |
