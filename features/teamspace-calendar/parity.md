...
| 2026-09-23 | claude   | Endpoints corrected to the implemented tenant-level routes (`GET /appointments/calendar`, `PATCH /appointment-participants/:id`, teamspace variants); mobile day list specified; mobile tap → detail for organizers too (decision 2026-09-23); times in device local time. |
| 2026-09-25 | Claude (M2-Specs) | "Angebot buchen" entry corrected; booking flow moved to its own spec [teamspace-offer-booking](../teamspace-offer-booking/spec.md) |
