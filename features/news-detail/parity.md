...
- **Repository abstraction:** inject `NewsDetailRepository` via Riverpod family parameter keyed by context; `CommentsRepository` similarly abstracted.
...
| Repository injection   | Per-context Angular provider               | Per-context Riverpod provider family                              |
